...
## ※ 프로젝트 실행 방법은 dev 브랜치를 확인하세요!
<br>

# ⭐️ 밋로그:MEETLOG란?
## <span style="background-color:f5f0ff">화상회의 관리 플랫폼</span>

![Untitled](./Readme_IMG/meetlog.png)
...
| 포지션 | 이름 | Github |
|:----------:|:----------:|:----------:|
| **Frontend** | 좌정현 | [imhyunni](https://github.com/imhynni) |
| **Frontend** | 이해인 | [Haen1231](https://github.com/Haen1231) |
| **Backend** | 변재호 | [bjho606](https://github.com/bjho606) |

<br>

# 🛠 시스템 구조
![Meetlog system architecture.png](./Readme_IMG/Meetlog%20system%20architecture.png)
